...
URL Source: https://platform.moonshot.cn/docs/guide/engage-in-multi-turn-conversations-using-kimi-api

Markdown Content:
使用 Kimi API 进行多轮对话 - Moonshot AI 开放平台 - Kimi K2.5 大模型 API 服务
===============
...
*   [联系客服](https://platform.moonshot.cn/docs/guide/engage-in-multi-turn-conversations-using-kimi-api) 
*   [开发者交流群](https://platform.moonshot.cn/docs/guide/engage-in-multi-turn-conversations-using-kimi-api) 
*   [官方公众号](https://platform.moonshot.cn/docs/guide/engage-in-multi-turn-conversations-using-kimi-api) 
...
[调试工具使用说明](https://platform.moonshot.cn/docs/guide/use-moonpalace "调试工具使用说明")[使用视觉模型](https://platform.moonshot.cn/docs/guide/use-kimi-vision-model "使用视觉模型")
